...

{
	...
	//	test.log(Status.PASS, "Merchandising Menu Selected");
		...
		txtTerritorytate.sendKeys(com.islandpacific.testdata.InputDefineTerritory.TerritoryState());
		test.log(Status.PASS, "Territory State has been Created");
        WebElement txtTerPin = driver.findElement(By.xpath("//*[@id=\"ZIP\"]"));
        txtTerPin.clear();
        txtTerPin.sendKeys(com.islandpacific.testdata.InputDefineTerritory.TerritoryPostalCode());
        test.log(Status.PASS, "Territory Pin  Entered");
        WebElement txtTerCountry = driver.findElement(By.id("_OBJ_N66283"));
        txtTerCountry.clear();
        txtTerCountry.sendKeys(com.islandpacific.testdata.InputDefineTerritory.TerritoryContry());
