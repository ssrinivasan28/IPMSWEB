...
public class DefineZones extends BaseTest {
	...
	public void DefineZone() throws Exception {
		...
		btnOKK.click();
		System.out.println(com.islandpacific.testdata.InputDefineZones.Zonecode());
		System.out.println("Proceed OK ");

		// Enter ZoneName
		WebElement txtZoneName = driver.findElement(By.id("_OBJ_N65879"));
		txtZoneName.clear();
		txtZoneName.sendKeys(com.islandpacific.testdata.InputDefineZones.ZoneName());
		...
		txtZoneCompany.sendKeys(com.islandpacific.testdata.InputDefineZones.ZoneFinCompany());
