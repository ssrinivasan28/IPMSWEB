...

	{
		...
		test.log(Status.PASS, "Constant Defination Selected");
		 ...
		 WebElement mnuDeDist = driver.findElement(By.xpath("//*[@id=\"LABEL4_4\"]"));
	        ...
	        txtDistName.clear();
	        txtDistName.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictName());
	        test.log(Status.PASS, "District Name Entered");
	        WebElement txtDistToReg = driver.findElement(By.id("_OBJ_N65864"));
	        txtDistToReg.clear();
	        txtDistToReg.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictLinkToRegion());
	        test.log(Status.PASS, "District Linked to Region");
	        WebElement txtDistMan = driver.findElement(By.id("_OBJ_N65927"));
	        txtDistMan.clear();
	        txtDistMan.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictManager());
	        test.log(Status.PASS, "District Manager Name Entered");
	        WebElement txtDisPhone = driver.findElement(By.id("_OBJ_N65988"));
	        txtDisPhone.clear();
	        txtDisPhone.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictTelephone());
	        test.log(Status.PASS, "District Phone Entered");
	        WebElement txtDistAdd1 = driver.findElement(By.id("ADDR1"));
	        txtDistAdd1.clear();
	        txtDistAdd1.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictAddressOne());
	        test.log(Status.PASS, "District Address1 Entered");
	        WebElement txtDistAdd2 = driver.findElement(By.id("_OBJ_N66159"));
	        txtDistAdd2.clear();
	        txtDistAdd2.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictAddressTwo());
	        test.log(Status.PASS, "District Address 2 Entered");
	        WebElement txtDistCity = driver.findElement(By.id("_OBJ_N66220"));
	        txtDistCity.clear();
	        txtDistCity.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictCity());
	        test.log(Status.PASS, "District City Entered");
	        WebElement txtDistState = driver.findElement(By.id("_OBJ_N66259"));
	        txtDistState.clear();
	        txtDistState.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictState());
	        test.log(Status.PASS, "District State Entered");
	        WebElement txtDistPin = driver.findElement(By.xpath(".//*[@id='ZIP']"));
	        txtDistPin.clear();
	        txtDistPin.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictPostalCode());
	        ...
	        txtDistCountry.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineDistrict.DistrictContry());
