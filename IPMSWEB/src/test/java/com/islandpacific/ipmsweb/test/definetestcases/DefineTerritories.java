...

{
	...
	//	test.log(Status.PASS, "Merchandising Menu Selected");
		...
		TxtTerName.clear();
		TxtTerName.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryName());
		test.log(Status.PASS, "Territory Name Entered");
		WebElement txtTerLnkZone = driver.findElement(By.id("_OBJ_N65765"));
		txtTerLnkZone.clear();
		txtTerLnkZone.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryLinkToZone());
		test.log(Status.PASS, "Territory Linked to Zone");
		WebElement TxtTerManager= driver.findElement(By.id("_OBJ_N65826"));
		TxtTerManager.clear();
		TxtTerManager.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryManager());
		test.log(Status.PASS, "Territory Manager Name Entered");
		WebElement txtTerTel = driver.findElement(By.id("_OBJ_N65887"));
		txtTerTel.clear();
		txtTerTel.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryTelephone());
		test.log(Status.PASS, "Territory Phone Entered");
		WebElement txtTerAdd1 = driver.findElement(By.xpath(".//*[@id='ADDR1']"));
		txtTerAdd1.clear();
		txtTerAdd1.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryAddressOne());
		test.log(Status.PASS, "Territory Address1 Entered");
		WebElement TxtTerAdd2 = driver.findElement(By.id("_OBJ_N66058"));
		TxtTerAdd2.clear();
		TxtTerAdd2.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryAddressTwo());
		test.log(Status.PASS, "Territory Address 2 Entered");
		WebElement TxtTerCity = driver.findElement(By.id("_OBJ_N66119"));
		TxtTerCity.clear();
		TxtTerCity.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryCity());
		...
		txtTerritorytate.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryState());
		test.log(Status.PASS, "Territory State has been Created");
        WebElement txtTerPin = driver.findElement(By.xpath("//*[@id=\"ZIP\"]"));
        txtTerPin.clear();
        txtTerPin.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryPostalCode());
        test.log(Status.PASS, "Territory Pin  Entered");
        WebElement txtTerCountry = driver.findElement(By.id("_OBJ_N66283"));
        txtTerCountry.clear();
        txtTerCountry.sendKeys(com.islandpacific.ipmsweb.testdata.constantdefinations.InputDefineTerritory.TerritoryContry());
