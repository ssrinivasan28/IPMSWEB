...
public class PurchaseOrderEntry extends BaseTest {
	...
	//	txtFileGroup.sendKeys("700");
		txtFileGroup.sendKeys(com.islandpacific.ipmsweb.testdata.purchaseorder.InputPOEntry.FileGroupEntry());
	...
	//	txtBlockOut.sendKeys("SSR2009194");
		txtBlockOut.sendKeys(com.islandpacific.ipmsweb.testdata.purchaseorder.InputPOEntry.BlockOutEntry());
		...
		txtVendor.clear();
		txtVendor.sendKeys(com.islandpacific.ipmsweb.testdata.purchaseorder.InputPOEntry.VendorEntry());
		...
		txtDepartment.clear();
		txtDepartment.sendKeys(com.islandpacific.ipmsweb.testdata.purchaseorder.InputPOEntry.DepartMentEntry());
	...
	//	System.out.println(Sku);
		txtSKU.sendKeys(com.islandpacific.ipmsweb.testdata.purchaseorder.InputPOEntry.SKUEntry());
	//	txtSKU.sendKeys(Sku);
	//	txtSKU.sendKeys("0000115675");
		...
		txtQuantity.clear();
		txtQuantity.sendKeys(com.islandpacific.ipmsweb.testdata.purchaseorder.InputPOEntry.QtyEntry());
